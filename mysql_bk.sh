...
DB_USER='suporte'
DB_PASS='suporte'
DB_PARAM='--add-drop-table --add-locks --extended-insert --single-transaction --routines --triggers -quick'
...
# Excluindo backups com mais de 15 dias
echo "  -- Excluindo backups com mais de 15 dias ..."
rm -rf $BACKUP_DIR/$db.$(date --date "15 day ago" +%Y-%m-%d).tar.bz2
